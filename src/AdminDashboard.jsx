  ...
  return {
    ...
    latestNews: [
      ...
      },
      {
        ...
        description:
          "If skies cooperate, tonight’s total lunar eclipse carries the Moon fully through Earth’s umbra. My Eclipse Guide page gives precise contact times (P1–U4), real-time countdowns, a live shadow visualization, a visibility map, and altitude/azimuth guidance from your location — so you know exactly when to watch and where to look.",
      ...
      },
      {
        ...
        href: "https://share.google/ygz8Gk2nxRjco9OVz",
        external: true,
        shareHref: "/share/markarians-chain/",
        description:
          "Captured last night with ~1 hour total integration using 180-second exposures, this field reveals the heart of Markarian’s Chain in the Virgo Cluster. Dominating the frame are the massive ellipticals M84 and M86, with the interacting pair NGC 4435 and NGC 4438 (“The Eyes”) nearby. Fainter Virgo Cluster members fill the background—each a distant island universe tens of millions of light-years away.",
      ...
      },
      {
        ...
        date: "Feb 13, 2026",
        image: "/share/eclipse-lockscreen/Totality Lock Screen.jpg",
