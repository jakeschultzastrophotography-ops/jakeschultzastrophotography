 ...
 *   /share/eclipse-lockscreen/
 *   /share/orion-nebula/
 *
 * Those share pages should include og:image pointing to:
 *   /images/share-previews/eclipse-lockscreen-og.jpg
 *   /images/share-previews/orion-nebula-og.jpg
 */
const LATEST_NEWS = [
  {
    ...
    cta: "View & Download",
    mediaFit: "contain", // contain shows full image; cover fills
  },
  {
    id: "orion-nebula",
            ...
            {LATEST_NEWS.map((post) => {
              ...
              return (
                <div key={post.id} className="mx-auto w-full max-w-2xl">
                  ...
                  {/* Media — full image, variable height, no forced aspect ratio */}
                  <button
                    type="button"
                    onClick={openPost}
                  ...
                  <div className="mt-4">
                    ...
                    {/* ✅ Share uses shareHref so Facebook picks up og:image */}
                    <ShareBar
                      title={post.title}
